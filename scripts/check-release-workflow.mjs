...
for (const target of ["preflight", "build", "stage", "verify"]) {
...
requireText("node-version-file: soksak-sidecars/soksak-sidecar-terminal-alacritty/.dependency/spec-package/package.json", "Node owner file");
